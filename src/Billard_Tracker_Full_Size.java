...
public class Billard_Tracker_Full_Size implements PlugInFilter {
    ...
    public void run(ImageProcessor ip1) {
        ...
        for (int y = 0; y < h1; y++) {
            for (int x = 0; x < w1; x++) {
                ...
                pixHue[i1] = (byte) (int) (hsb[0] * MAX_VALUE);
//                pixGray[i1] = (byte) (int) (hsb[2] * MAX_VALUE);
    ...
    public static void main(String[] args) {
        Billard_Tracker_Full_Size plugin = new Billard_Tracker_Full_Size();
